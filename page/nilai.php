        ...
        <div class="panel">
            <div class="panel-top">
                ...
                <div style="float:right;width: 250px;">
                    <select class="form-custom" name="pilih" id="pilihNilai">
                        <option value="">Semua Jenis Penginapan</option>;
                        <?php
                        $query="SELECT*FROM jenis_penginapan";
                        $execute=$konek->query($query);
                        if ($execute->num_rows > 0){
                            while ($data=$execute->fetch_array(MYSQLI_ASSOC)){
                           if ($pilih==$data[id_jenispenginapan]) {
                                $selected="selected";
                            }else{
                                $selected=null;
                            }
                                echo "<option $selected value=$data[id_jenispenginapan]>$data[namaPenginapan]</option>";
                            }
                        }else{
            ...
            <div class="panel-middle" id="animation">
                <div class="table-responsive">
                    <table>
                        <thead><tr><th>No</th><th>Nama Penginapan</th><th>Nama Perusahaan</th><th>Aksi</th></tr></thead>
